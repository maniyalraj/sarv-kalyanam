  ...
  return (
    <Card className="group h-full overflow-hidden transition-all hover:shadow-hover hover:-translate-y-2">
      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-primary-50 to-primary-100">
        <img 
          src={`https://images.unsplash.com/photo-${doctor.id === '1' ? '1612349317150-e973f38f1d8c' : doctor.id === '2' ? '1559839734-2b71ea197ec2' : doctor.id === '3' ? '1622253694317-7f08fb1d6e4c' : '1612349317150-e973f38f1d8c'}?w=400&q=80`}
          alt={doctor.name}
      ...
      <CardContent className="p-6">
        ...
        <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
          <div>
            ...
            <p className="text-lg font-bold text-dark">{formatCurrency(doctor.fees)}</p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {filteredDoctors.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-dark">No Doctors Found</h3>
